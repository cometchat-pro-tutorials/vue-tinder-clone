<template>
  <q-layout>
    ...
    <q-page-container>
      <q-page padding>
        <section class="fixed-center full-width q-px-xl">
          ...
          <div class="row items-center justify-center q-pb-md q-mt-xl">
      ...
      <img src="~assets/couple.svg" class="block fixed-bottom" width="250px" style="left: -15%; z-index: -1; opacity: .8"/>
    </q-page-container>
  </q-layout>
</template>
